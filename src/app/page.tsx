...
export default function Home() {
  ...
  const handleDownloadQuestions = () => {
    ...
    // Header
    content += `AI GENERATOR SOAL UJIAN\n`;
    content += `=====================================\n\n`;
    ...
    // Footer
    content += `=====================================\n`;
    content += `Generated by AI Generator Soal Ujian\n`;
  ...
  const handleDownloadPDF = () => {
    ...
    doc.setFontSize(10);
    doc.text('Generated by AI Generator Soal Ujian', 105, yPosition, { align: 'center' });
    yPosition += lineHeight;
            ...
            <div className="mb-8">
              ...
              <div>
                ...
                <div className="mt-2 text-sm text-gray-500">
                  📝 Ketik materi pembelajaran minimal 50 karakter
                </div>
              </div>
            </div>
